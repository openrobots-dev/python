...
def _main():
    ...
    try:
        ...
        transport.advertise(rpub, args.boot_topic_name, r2p.Time_INFINITE, r2p.BootMsg) # FIXME: Should be automatic
        transport.subscribe(rsub, args.boot_topic_name, r2p.BootMsg) # FIXME: Should be automatic
